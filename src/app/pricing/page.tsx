...
function FeatureItem({ text }: { text: string }) {
  ...
  return (
    <li className="flex items-start gap-2.5">
      <Check className={`h-4 w-4 mt-0.5 shrink-0 ${isDivider ? 'text-[#17b6a7]/60' : 'text-[#17b6a7]'}`} />
  ...
  return (
    <div className="border border-white/10 rounded-xl overflow-hidden">
      ...
      >
        ...
        <ChevronDown className={`h-5 w-5 text-[#17b6a7] shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} />
      </button>
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <p className="px-6 pb-5 text-gray-300 text-sm leading-relaxed border-t border-white/8 pt-4">{a}</p>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-3xl mx-auto">
          <motion.h1 {...fadeUp(0)} className="text-4xl sm:text-5xl font-bold mb-5 leading-tight">
            Pricing Built for <span className="text-[#17b6a7]">Egyptian Clinics</span>
          </motion.h1>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/40 border-y border-white/8">
        <div className="max-w-3xl mx-auto">
          <motion.div {...fadeUp(0)} className="text-center mb-10">
            <p className="text-sm font-semibold uppercase tracking-widest text-[#17b6a7] mb-3">After Launch</p>
          ...
          <motion.ul {...fadeUp(0.15)} className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          <motion.h2 {...fadeUp(0)} className="text-3xl font-bold text-center mb-10">Common Questions</motion.h2>
